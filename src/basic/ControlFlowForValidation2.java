...
public class ControlFlowForValidation2
{
	public static void main (String args[])		//validasi hutang dan gaji
	{
		...
		boolean validHutang = true;
		//boolean validGaji = false;
		boolean validGaji = true;
		System.out.print("\n");
		System.out.println("===============================");
		...
		for( validHutang = true; validHutang==true;)
		//while(!validHutang)
		{
		...
		for(validGaji=true; validGaji==true;)
